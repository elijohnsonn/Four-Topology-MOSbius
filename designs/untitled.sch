...
plot v(x1.en_0_5t) v(clk)
meas tran en_last_clk find v(x1.en_0_5t) at=0.424m
meas tran en_settled find v(x1.en_0_5t) at=0.5m
print en_last_clk en_settled
meas tran out_last_clk find v(out_5t) at=0.424m
meas tran out_settled find v(out_5t) at=2m
print out_last_clk out_settled

meas tran out_after_clk find v(out_5t) at=0.5m
meas tran out_settled find v(out_5t) at=2m
print out_last_clk out_after_clk out_settled
...
C {vsource.sym} -1570 160 0 0 {name=V8 value= "dc 1.65 ac 0 sin(1.65 200m 500 1m)" savecurrent=false}
