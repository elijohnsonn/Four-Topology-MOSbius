...
C {devices/lab_wire.sym} 1130 -350 0 0 {name=p1 sig_type=std_logic lab=vout}
C {devices/lab_wire.sym} 1000 -410 0 0 {name=p5 sig_type=std_logic lab=VDD}
C {devices/gnd.sym} 1150 -210 0 0 {name=l3 lab=GND}
C {devices/code_shown.sym} 30 -480 0 0 {name=Simulation only_toplevel=false value="
.control
...
C {vsource.sym} 670 -290 0 0 {name=V3 value=1.65 savecurrent=false}
C {devices/gnd.sym} 670 -260 0 0 {name=l4 lab=GND}
