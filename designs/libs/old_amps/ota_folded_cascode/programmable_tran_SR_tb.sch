...
C {libs/core_amps/ota_folded_cascode/programmable_folded.sym} 340 -90 0 0 {name=x1}
...
C {lab_pin.sym} 170 60 0 1 {name=p2 sig_type=std_logic lab=VG_BIAS}
...
C {lab_pin.sym} 120 -220 0 1 {name=p8 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 120 40 0 0 {name=p9 sig_type=std_logic lab=GND}
...
C {lab_pin.sym} -70 -170 0 0 {name=p13 sig_type=std_logic lab=VDD}
