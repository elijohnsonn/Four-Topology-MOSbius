...
C {lab_pin.sym} 180 190 0 0 {name=p6 sig_type=std_logic lab=GND}
...
C {vsource.sym} -140 120 0 0 {name=V1 value=1.65 savecurrent=false}
C {vsource.sym} -40 120 0 0 {name=V3 value=1.65 savecurrent=false}
C {lab_pin.sym} -40 190 0 0 {name=p9 sig_type=std_logic lab=GND}
C {lab_pin.sym} -140 190 0 0 {name=p10 sig_type=std_logic lab=GND}
