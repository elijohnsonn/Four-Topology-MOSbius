...
P 4 1 -1080 -40 {}
P 4 1 830 -20 {}
N -910 -380 -910 -320 {lab=VDD}
N -1020 -70 -1020 -10 {lab=VDD}
N -1030 -380 -1030 -320 {lab=GND}
N -1030 -260 -1030 -210 {lab=GND}
N -910 -260 -910 -210 {lab=GND}
N -1020 80 -1020 120 {lab=VBN1}
N -910 -210 -910 -200 {lab=GND}
N -1020 120 -1020 140 {lab=VBN1}
N -1020 110 -950 110 {lab=VBN1}
N -950 110 -950 170 {lab=VBN1}
N -980 170 -950 170 {lab=VBN1}
N -950 170 -920 170 {lab=VBN1}
N -1020 200 -1020 240 {lab=GND}
N -1090 170 -1020 170 {lab=GND}
N -1090 170 -1090 220 {lab=GND}
N -1090 220 -1020 220 {lab=GND}
...
N 200 -370 200 -310 {lab=VDD}
N 200 -370 510 -370 {lab=VDD}
N 510 -370 510 -310 {lab=VDD}
...
N -40 100 -40 150 {lab=GND}
N -110 150 -40 150 {lab=GND}
N -230 -50 -10 -50 {lab=GND}
N 150 180 200 180 {lab=GND}
N 150 180 150 260 {lab=GND}
N 150 260 200 260 {lab=GND}
N 150 30 200 30 {lab=GND}
N 150 30 150 180 {lab=GND}
N 510 30 570 30 {lab=GND}
N 510 260 570 260 {lab=GND}
N 570 30 570 260 {lab=GND}
N 510 180 570 180 {lab=GND}
N 150 -150 200 -150 {lab=VDD}
N 510 -150 570 -150 {lab=VDD}
N 510 -280 580 -280 {lab=VDD}
N 580 -370 580 -280 {lab=VDD}
N 510 -370 580 -370 {lab=VDD}
N 140 -280 200 -280 {lab=VDD}
N 130 -280 140 -280 {lab=VDD}
N 130 -370 130 -280 {lab=VDD}
N 130 -370 200 -370 {lab=VDD}
N -680 60 -680 150 {lab=VBP1}
N -680 -40 -680 0 {lab=VDD}
N -1020 50 -1020 80 {lab=VBN1}
N -680 -60 -680 -40 {lab=VDD}
N -730 30 -680 30 {lab=VDD}
N -730 -30 -730 30 {lab=VDD}
N -730 -30 -680 -30 {lab=VDD}
N -640 30 -510 30 {lab=VBP1}
N -680 80 -590 80 {lab=VBP1}
N -590 30 -590 80 {lab=VBP1}
N -920 170 -900 170 {lab=VBN1}
...
C {vsource.sym} -910 -290 0 0 {name=V2 value=3.3 savecurrent=false}
C {lab_pin.sym} -1030 -380 0 0 {name=p3 sig_type=std_logic lab=GND}
C {gnd.sym} -1030 -210 0 0 {name=l1 lab=GND}
C {lab_pin.sym} -910 -200 0 0 {name=p4 sig_type=std_logic lab=GND}
C {symbols/nfet_03v3.sym} -1000 170 0 1 {name=M1
L=.5u
W=23u
nf=1
m=1
...
C {lab_pin.sym} -1020 260 0 0 {name=p5 sig_type=std_logic lab=GND}
...
C {lab_pin.sym} 370 290 0 0 {name=p7 sig_type=std_logic lab=GND}
...
C {lab_pin.sym} -680 -60 0 0 {name=p31 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -550 30 1 0 {name=p33 sig_type=std_logic lab=VBP1}
C {devices/code_shown.sym} 1110 -210 0 0 {name=Models only_toplevel=false
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice typical
"}
C {code_shown.sym} 1120 -40 0 0 {name=Simulation only_toplevel=false 
...
C {symbols/nfet_03v3.sym} -700 170 0 0 {name=M13
L=.5u
W=23u
nf=1
m=1
