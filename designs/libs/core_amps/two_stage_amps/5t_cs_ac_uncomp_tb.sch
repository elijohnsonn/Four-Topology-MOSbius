...
N -330 -130 -300 -130 {lab=INN}
N -330 -130 -330 -60 {lab=INN}
N -310 -110 -310 10 {lab=#net4}
...
N -310 -110 -300 -110 {lab=#net4}
N -360 -210 -360 -170 {lab=#net1}
N -360 -170 -300 -170 {lab=#net1}
N -160 -150 -110 -150 {lab=#net3}
...
C {lab_pin.sym} -230 -40 0 0 {name=p5 sig_type=std_logic lab=GND}
C {lab_pin.sym} 250 -260 0 0 {name=p6 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -230 -270 0 0 {name=p7 sig_type=std_logic lab=VDD}
C {isource.sym} -310 40 2 0 {name=IBIAS value=100u}
C {lab_pin.sym} -310 110 0 0 {name=p8 sig_type=std_logic lab=VDD}
...
"}
C {lab_pin.sym} -330 -60 3 0 {name=p14 sig_type=std_logic lab=INN}
...
"}
C {libs/core_amps/ota_5t/schem/5tOTA.sym} -230 -150 0 0 {name=x1}
