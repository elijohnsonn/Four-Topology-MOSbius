...
N -480 -130 -450 -130 {lab=INN}
N -480 -130 -480 -60 {lab=INN}
...
"}
C {lab_pin.sym} -480 -60 3 0 {name=p14 sig_type=std_logic lab=INN}
...
C {code_shown.sym} 640 150 0 0 {name=Simulation only_toplevel=false 
