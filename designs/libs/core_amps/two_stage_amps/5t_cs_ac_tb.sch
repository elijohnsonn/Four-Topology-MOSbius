...
N -320 10 -290 10 {lab=INN}
N -320 10 -320 80 {lab=INN}
...
N -220 50 -220 80 {lab=GND}
N -390 -70 -290 -30 {lab=#net1}
N -300 30 -300 150 {lab=#net6}
N -300 30 -290 30 {lab=#net6}
...
C {lab_pin.sym} -220 130 0 0 {name=p5 sig_type=std_logic lab=GND}
C {lab_pin.sym} 220 -120 0 0 {name=p6 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -220 -130 0 0 {name=p7 sig_type=std_logic lab=VDD}
C {isource.sym} -300 180 2 0 {name=IBIAS value=100u}
C {lab_pin.sym} -300 250 0 0 {name=p8 sig_type=std_logic lab=VDD}
...
meas ac a0_db find gain_db at=5
...
.endc
"}
C {lab_pin.sym} -320 80 3 0 {name=p14 sig_type=std_logic lab=INN}
...
C {libs/core_amps/ota_5t/schem/5tOTA.sym} -220 -10 0 0 {name=x1}
