...
N -270 -130 -270 -70 {lab=VDD}
N 220 -120 220 -40 {lab=VDD}
N 100 50 150 50 {lab=#net1}
N 100 50 100 130 {lab=#net1}
N -350 140 -350 180 {lab=VDD}
...
N -480 380 -360 380 {lab=#net2}
N -620 220 -620 250 {lab=GND}
N -480 80 -480 380 {lab=#net2}
...
N -30 -140 10 -140 {lab=#net4}
N -90 -10 60 -10 {lab=#net3}
N 70 -140 310 -140 {lab=output}
N 310 -140 340 -140 {lab=output}
N 340 -140 340 10 {lab=output}
N -200 370 -60 370 {lab=#net2}
N -200 430 -200 460 {lab=GND}
N 0 370 120 370 {lab=#net5}
N 120 370 120 410 {lab=#net5}
N 120 470 120 510 {lab=GND}
N 120 490 160 490 {lab=GND}
N 160 460 160 490 {lab=GND}
N -360 380 -240 380 {lab=#net2}
N -240 370 -240 380 {lab=#net2}
N -240 370 -200 370 {lab=#net2}
N 160 420 400 420 {lab=output}
N 400 380 400 420 {lab=output}
N -120 -140 -120 -10 {lab=#net3}
N -120 -140 -90 -140 {lab=#net3}
N -390 10 -390 80 {lab=INN}
N -390 10 -340 10 {lab=INN}
N -200 -10 -140 -10 {lab=#net3}
N -269.9609375 50 -269.9609375 100 {lab=GND}
N -270 100 -269.9609375 100 {lab=GND}
N -350 30 -350 80 {lab=#net6}
...
C {lab_pin.sym} -270 -130 0 0 {name=p7 sig_type=std_logic lab=VDD}
C {isource.sym} -350 110 2 0 {name=IBIAS value=100u}
C {lab_pin.sym} -350 180 0 0 {name=p8 sig_type=std_logic lab=VDD}
