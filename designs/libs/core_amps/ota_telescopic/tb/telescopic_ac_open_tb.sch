...
N -1250 -780 -1250 -720 {lab=VDD}
N -1250 -490 -1250 -470 {lab=#net1}
...
N -1370 -610 -1310 -610 {lab=#net3}
N -1370 -610 -1370 -550 {lab=#net3}
N -1380 -680 -1310 -680 {lab=#net4}
C {isource.sym} -1250 -440 2 0 {name=IBIAS value=100u}
...
"}
C {lab_pin.sym} -1250 -780 0 0 {name=p2 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -1230 -500 0 1 {name=p5 sig_type=std_logic lab=GND}
...
C {lab_pin.sym} -1250 -370 0 0 {name=p6 sig_type=std_logic lab=VDD}
...
C {libs/core_amps/ota_telescopic/telescopic_cascode.sym} -1250 -640 0 0 {name=X1}
