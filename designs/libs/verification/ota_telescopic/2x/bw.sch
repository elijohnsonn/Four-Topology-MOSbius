...
device=resistor
m=1}
C {vsource.sym} -830 30 0 0 {name=V6 value= "dc 1.65 ac 0 sin(1.65 10m 399.95k 1m)" savecurrent=false}
...
C {vsource.sym} 900 250 0 0 {name=V3 value= "PWL(0 0 0.2999m 0 0.3m 3.3 0.349999m 3.3 0.35m 0)" savecurrent=false}
