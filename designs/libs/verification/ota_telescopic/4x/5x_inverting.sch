...
N 20 130 150 130 {lab=OUT_TELESCOPIC}
N 150 130 150 160 {lab=OUT_TELESCOPIC}
N 150 130 220 130 {lab=OUT_TELESCOPIC}
N 150 220 150 250 {lab=GND}
N 80 130 80 390 {lab=OUT_TELESCOPIC}
N -160 390 80 390 {lab=OUT_TELESCOPIC}
N -580 390 -220 390 {lab=#net1}
N -600 90 -600 390 {lab=#net1}
N -660 90 -460 90 {lab=#net1}
...
N -990 60 -990 150 {lab=#net2}
N -930 60 -460 60 {lab=#net2}
N -990 60 -930 60 {lab=#net2}
N -540 300 -540 330 {lab=VDD}
N -600 390 -580 390 {lab=#net1}
N -540 150 -460 150 {lab=#net3}
N -540 150 -540 240 {lab=#net3}
...
N 520 -160 520 -110 {lab=#net4}
N 520 -50 520 -10 {lab=GND}
N 520 -170 620 -170 {lab=#net4}
N 520 -170 520 -160 {lab=#net4}
...
C {libs/core_tb/schem/DUT.sym} -230 70 0 0 {name=x1}
...
.endc
"}
C {capa.sym} 150 190 0 0 {name=CLOAD
m=1
value=120p
footprint=1206
device="ceramic capacitor"}
C {lab_pin.sym} 220 130 0 1 {name=p11 sig_type=std_logic lab=OUT_TELESCOPIC}
C {gnd.sym} 150 250 0 0 {name=l8 lab=GND}
