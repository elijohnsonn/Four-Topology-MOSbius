...
N 290 90 360 90 {lab=OUT_TELESCOPIC}
N 290 180 290 210 {lab=GND}
...
N 290 90 290 100 {lab=OUT_TELESCOPIC}
N 290 100 290 120 {lab=OUT_TELESCOPIC}
...
.endc
"}
C {capa.sym} 290 150 0 0 {name=CLOAD
m=1
value=120p
footprint=1206
device="ceramic capacitor"}
C {lab_pin.sym} 360 90 0 1 {name=p11 sig_type=std_logic lab=OUT_TELESCOPIC}
...
C {vsource.sym} 150 140 0 1 {name=V2 value=1.65 savecurrent=false}
C {gnd.sym} 150 170 0 1 {name=l2 lab=GND}
C {lab_pin.sym} 200 140 1 1 {name=p6 sig_type=std_logic lab=CLK_ENA}
C {lab_pin.sym} 220 140 3 0 {name=p22 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 240 140 1 1 {name=p23 sig_type=std_logic lab=!CLK_ENA}
C {libs/core_amps/switch/switch2.sym} 220 100 0 0 {name=x2}
