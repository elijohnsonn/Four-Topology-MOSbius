...
T {CL = 120p} -290 -10 0 0 0.75 0.75 {}
...
N -1220 -160 -1050 -160 {lab=INP_5T}
N -1160 -130 -1050 -130 {lab=OUT_5T}
N -570 -90 -520 -90 {lab=OUT_5T}
N -520 -90 -390 -90 {lab=OUT_5T}
N -440 -90 -440 390 {lab=OUT_5T}
N -1720 170 -1720 200 {lab=GND}
N -390 -90 -330 -90 {lab=OUT_5T}
N -1720 -160 -1720 40 {lab=INP_5T}
N -1580 -160 -1220 -160 {lab=INP_5T}
N -1720 40 -1720 70 {lab=INP_5T}
N -370 -90 -370 -60 {lab=OUT_5T}
N -370 0 -370 40 {lab=GND}
N -1720 70 -1720 110 {lab=INP_5T}
N -1240 -130 -1160 -130 {lab=OUT_5T}
N -650 430 -440 430 {lab=OUT_5T}
N -780 430 -650 430 {lab=OUT_5T}
N -1240 430 -840 430 {lab=OUT_5T}
N -1720 -160 -1670 -160 {lab=INP_5T}
N -1670 -160 -1580 -160 {lab=INP_5T}
...
N -840 430 -780 430 {lab=OUT_5T}
N -1240 -130 -1240 430 {lab=OUT_5T}
N -440 390 -440 430 {lab=OUT_5T}
...
C {lab_pin.sym} -330 -90 0 1 {name=p11 sig_type=std_logic lab=OUT_5T}
...
"}
C {gnd.sym} -1720 200 0 0 {name=l9 lab=GND}
C {capa.sym} -370 -30 0 0 {name=CLOAD
m=1
value=120p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -370 40 0 0 {name=l8 lab=GND}
C {lab_pin.sym} -1720 -160 0 0 {name=p12 sig_type=std_logic lab=INP_5T}
...
C {vsource.sym} 550 420 0 0 {name=V2 value="PWL(0 0 0.1499m 0 0.15m 3.3 0.24999m 3.3 0.25m 0)" savecurrent=false}
...
.endc
"}
C {vsource.sym} -1720 140 0 0 {name=V3 value="dc 1.65 ac 0 pulse(1.65 3.3 1m 2m 2m 0.01u 4m)" savecurrent=false}
