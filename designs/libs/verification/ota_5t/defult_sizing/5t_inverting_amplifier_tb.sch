...
N 300 -60 300 320 {lab=OUT_5t}
N 60 320 300 320 {lab=OUT_5t}
N -360 320 0 320 {lab=#net1}
N -380 -30 -380 320 {lab=#net1}
...
C {vsource.sym} 520 190 0 0 {name=V1 value=3.3 savecurrent=false}
C {gnd.sym} 520 260 0 0 {name=l5 lab=GND}
C {lab_pin.sym} 520 110 0 0 {name=p8 sig_type=std_logic lab=VDD}
