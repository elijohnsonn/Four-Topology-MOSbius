...
device=resistor
m=1}
C {vsource.sym} -1570 80 0 0 {name=V6 value= "dc 1.65 ac 0 sin(1.65 10m 10k 1m)" savecurrent=false}
...
C {code_shown.sym} 1390 -80 0 0 {name=Simulation2 only_toplevel=false 
