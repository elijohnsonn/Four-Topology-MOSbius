...
let iso_5t = 20 * log(five_t_pp / folded_pp) / log(10)
let iso_tele = 20 * log(tele_pp / folded_pp) / log(10)
let iso_cs = 20 * log(cs_pp / folded_pp) / log(10)

print iso_5t iso_tele iso_cs
.endc
"}
...
C {lab_pin.sym} -550 -90 0 1 {name=p4 sig_type=std_logic lab=OUT_5T}
...
C {vsource.sym} 560 420 0 0 {name=V3 value="PWL(0 0 0.34999m 0 0.35m 3.3 0.499999m 3.3 0.5m 0)" savecurrent=false}
