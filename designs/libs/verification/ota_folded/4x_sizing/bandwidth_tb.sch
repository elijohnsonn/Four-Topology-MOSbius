...
device=resistor
m=1}
C {vsource.sym} -1570 90 0 0 {name=V6 value= "dc 1.65 ac 0 sin(1.65 10m 1Meg 1m)" savecurrent=false}
...
.endc
"}
C {vsource.sym} 560 430 0 0 {name=V2 value="PWL(0 0 0.34999m 0 0.35m 3.3 0.499999m 3.3 0.5m 0)" savecurrent=false}
