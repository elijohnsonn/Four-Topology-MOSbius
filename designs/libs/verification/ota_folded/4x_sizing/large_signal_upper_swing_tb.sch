...
C {vsource.sym} -1720 80 0 0 {name=V3 value="dc 1.65 ac 0 pulse(1.65 3.3 1m 2m 2m 0.01u 4m)" savecurrent=false}
C {code_shown.sym} 1370 -70 0 0 {name=Simulation1 only_toplevel=false 
