...
C {devices/code_shown.sym} 920 -290 0 0 {name=MODELS only_toplevel=true
...
wrdata /foss/designs/libs/verification/start_up_cir/folded/default.csv v(out_folded) v(inn_folded)
