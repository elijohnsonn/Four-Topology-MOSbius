...
C {lab_pin.sym} -180 -90 0 1 {name=p11 sig_type=std_logic lab=OUT_5T}
...
wrdata /foss/designs/libs/pex/5t/inverting_amplifier/with_start_cir/default.csv v(out_5T) v(inn_5T)
...
C {capa.sym} -220 -30 0 0 {name=CLOAD
m=1
value=120p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -220 40 0 0 {name=l8 lab=GND}
