...
N 20 90 150 90 {lab=OUT_TELESCOPIC}
N 150 90 150 120 {lab=OUT_TELESCOPIC}
N 150 90 220 90 {lab=OUT_TELESCOPIC}
N 150 180 150 210 {lab=GND}
N 80 90 80 350 {lab=OUT_TELESCOPIC}
N -160 350 80 350 {lab=OUT_TELESCOPIC}
N -580 350 -220 350 {lab=#net1}
N -600 50 -600 350 {lab=#net1}
N -660 50 -460 50 {lab=#net1}
...
N -990 20 -990 110 {lab=#net2}
N -930 20 -460 20 {lab=#net2}
N -990 20 -930 20 {lab=#net2}
N -540 260 -540 290 {lab=VDD}
N -600 350 -580 350 {lab=#net1}
N -540 110 -460 110 {lab=#net3}
N -540 110 -540 200 {lab=#net3}
...
N 520 -200 520 -150 {lab=#net4}
N 520 -90 520 -50 {lab=GND}
N 520 -210 620 -210 {lab=#net4}
N 520 -210 520 -200 {lab=#net4}
...
.endc
"}
C {capa.sym} 150 150 0 0 {name=CLOAD
m=1
value=120p
footprint=1206
device="ceramic capacitor"}
C {lab_pin.sym} 220 90 0 1 {name=p11 sig_type=std_logic lab=OUT_TELESCOPIC}
C {gnd.sym} 150 210 0 0 {name=l8 lab=GND}
