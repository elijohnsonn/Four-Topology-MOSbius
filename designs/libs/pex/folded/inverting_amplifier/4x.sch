...
T {CL = 120p} -270 -80 0 0 0.75 0.75 {}
T {DC = 1.65V
500Hz Frequency 
50mV Amplitude
...
N -550 -160 -500 -160 {lab=OUT_FOLDED}
N -500 -160 -370 -160 {lab=OUT_FOLDED}
N -420 -160 -420 320 {lab=OUT_FOLDED}
N -1220 -20 -1220 320 {lab=#net2}
N -1220 -150 -1220 -80 {lab=#net2}
N -1700 100 -1700 130 {lab=GND}
N -370 -160 -310 -160 {lab=OUT_FOLDED}
N -1700 -230 -1700 -30 {lab=INP_FOLDED}
N -1560 -230 -1200 -230 {lab=INP_FOLDED}
N -1700 -30 -1700 0 {lab=INP_FOLDED}
N -350 -160 -350 -130 {lab=OUT_FOLDED}
N -350 -70 -350 -30 {lab=GND}
...
N -630 420 -420 420 {lab=OUT_FOLDED}
N -420 320 -420 420 {lab=OUT_FOLDED}
N -760 420 -630 420 {lab=OUT_FOLDED}
...
N 220 -190 220 -140 {lab=#net3}
N 220 -80 220 -40 {lab=GND}
N 220 -200 320 -200 {lab=#net3}
...
C {lab_pin.sym} -310 -160 0 1 {name=p11 sig_type=std_logic lab=OUT_FOLDED}
...
C {capa.sym} -350 -100 0 0 {name=CLOAD
m=1
value=120p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -350 -30 0 0 {name=l8 lab=GND}
