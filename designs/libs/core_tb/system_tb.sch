...
N -430 380 -20 380 {lab=#net6}
N -430 40 -430 380 {lab=#net6}
N -430 -90 -430 -20 {lab=INPUT}
N -540 -90 -460 -90 {lab=INPUT}
N -680 10 -680 50 {lab=GND}
...
C {gnd.sym} -410 -140 0 0 {name=l8 lab=GND}
C {lab_pin.sym} 420 -100 0 1 {name=p11 sig_type=std_logic lab=OUT_FOLDED}
...
.endc
"}
C {vsource.sym} -680 -20 0 0 {name=V6 value= "DC 1.65 sin(1.65 100m 10k)" savecurrent=false}
C {gnd.sym} -680 50 0 0 {name=l9 lab=GND}
