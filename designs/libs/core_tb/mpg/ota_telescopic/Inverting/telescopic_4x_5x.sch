...
enable telescopic cascode 4x sizing} 530 -620 0 0 0.4 0.4 {}
...
T {Configure the telescopic cascode in 4× mode 
...
C {lab_pin.sym} -740 -750 2 1 {name=p7 sig_type=std_logic lab=VDD}
