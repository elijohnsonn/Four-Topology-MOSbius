...
telescopic cascode 2x and common source 2x sizing} 380 160 0 0 0.4 0.4 {}
T {CL = 120p} -260 150 0 0 0.75 0.75 {}
T {IBIAS = 100u} -1260 160 0 0 0.4 0.4 {}
T {IMPLEMENTATION} -1230 -680 0 0 1 1 {}
T {Configure the telescopic cascode in 2× mode and the common source stage 
in 2x mode as a unity gain amplifier, stepping the input the input by 1 V while driving a 120pF capacitive load.} -1350 -610 0 0 0.4 0.4 {}
...
N -530 -80 -490 -80 {lab=#net5}
N -320 -80 -290 -80 {lab=OUT_CS}
N -290 -80 -290 -20 {lab=OUT_CS}
...
N -430 -80 -380 -80 {lab=#net6}
N -1760 140 -1760 240 {lab=#net7}
N -1760 0 -1760 80 {lab=INN_TELESCOPIC}
N -1760 -60 -1760 0 {lab=INN_TELESCOPIC}
N -1530 -120 -1510 -120 {lab=INN_TELESCOPIC}
N -1740 -120 -1590 -120 {lab=INN_TELESCOPIC}
N -1760 -120 -1740 -120 {lab=INN_TELESCOPIC}
N -1760 -120 -1760 -60 {lab=INN_TELESCOPIC}
N -530 -80 -530 240 {lab=#net5}
N -1590 -120 -1530 -120 {lab=INN_TELESCOPIC}
...
C {res.sym} -460 -80 1 0 {name=R3
value=2.7k
footprint=1206
device=resistor
m=1}
C {capa.sym} -350 -80 1 0 {name=CLOAD1
m=1
value=25p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -1760 310 0 0 {name=l9 lab=GND}
C {lab_pin.sym} -1760 -120 0 0 {name=p13 sig_type=std_logic lab=INN_TELESCOPIC}
