...
telescopic cascode 3x and common source 3x sizing} 380 170 0 0 0.4 0.4 {}
T {CL = 120p} -260 160 0 0 0.75 0.75 {}
T {IBIAS = 100u} -1260 170 0 0 0.4 0.4 {}
T {IMPLEMENTATION} -1230 -670 0 0 1 1 {}
T {Configure the telescopic cascode in 3× mode and the common source stage 
in 3x mode as a unity gain amplifier, stepping the input the input by 1 V while driving a 120pF capacitive load.} -1350 -600 0 0 0.4 0.4 {}
