...
C {vsource.sym} 460 320 0 0 {name=V3 value=    "PWL(0 0 0.2499m 0 0.25m 3.3 0.29999m 3.3 0.3m 0)" savecurrent=false}
...
C {code_shown.sym} 930 0 0 0 {name=Simulation1 only_toplevel=false 
...
.endc"}
C {vsource.sym} -1670 300 0 0 {name=VINP2 value= "dc 1.65" savecurrent=false}
C {gnd.sym} -1670 330 0 0 {name=l9 lab=GND}
