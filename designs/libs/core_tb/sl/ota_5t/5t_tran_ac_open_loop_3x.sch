...
for AC open loop test.} -1160 -560 0 0 0.4 0.4 {}
...
N -1020 390 -880 390 {lab=#net5}
N -1020 470 -1020 500 {lab=GND}
N -820 390 -700 390 {lab=#net6}
N -700 390 -700 430 {lab=#net6}
N -700 490 -700 530 {lab=GND}
N -700 510 -660 510 {lab=GND}
N -660 480 -660 510 {lab=GND}
N -660 440 -530 440 {lab=OUT_5T}
N -1230 340 -1230 390 {lab=#net5}
N -1230 390 -1020 390 {lab=#net5}
N -530 440 -390 440 {lab=OUT_5T}
N -390 340 -390 440 {lab=OUT_5T}
N -1020 390 -1020 410 {lab=#net5}
...
plot vdb(OUT_5T) ph(v(OUT_5T))*180/3.14159

meas ac dc_gain find vdb(OUT_5T) at=1
let bw_level = dc_gain - 3
meas ac bw when vdb(OUT_5T) = bw_level fall=1
meas ac gbw when vdb(OUT_5T)=0
let gain_db = vdb(OUT_5T)
...
C {vsource.sym} -1710 160 0 0 {name=V6 value= "dc 1.65 AC" savecurrent=false
}
...
C {ind.sym} -850 390 1 0 {name=L9
m=1
value=1T
footprint=1206
device=inductor}
C {capa.sym} -1020 440 0 0 {name=CLOAD1
m=1
value=1T
footprint=1206
device="ceramic capacitor"}
C {lab_pin.sym} -1020 500 0 0 {name=p15 sig_type=std_logic lab=GND}
C {vcvs.sym} -700 460 0 1 {name=E1 value=1}
C {lab_pin.sym} -700 530 0 0 {name=p16 sig_type=std_logic lab=GND}
