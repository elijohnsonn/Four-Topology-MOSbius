...
N 250 -230 250 -180 {lab=#net3}
N 250 -120 250 -80 {lab=GND}
N 250 -240 350 -240 {lab=#net3}
N 250 -240 250 -230 {lab=#net3}
...
C {devices/code_shown.sym} 880 230 0 0 {name=MODELS only_toplevel=true
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice typical
"}
C {code_shown.sym} 880 340 0 0 {name=Simulation1 only_toplevel=false 
...
device=resistor
m=1}
C {vsource.sym} -1570 160 0 0 {name=V6 value= "dc 1.65 ac 0 pulse(1.60 1.70 1m 1m 1m 0.01m 2m)" savecurrent=false
}
