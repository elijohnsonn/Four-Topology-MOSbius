...
N -1230 -120 -1150 -120 {lab=#net6}
N -1310 -120 -1230 -120 {lab=#net6}
...
device=resistor
m=1}
C {vsource.sym} -1570 160 0 0 {name=V6 value= "dc 1.65 ac 0 pulse(1.60 1.70 0 1m 1m 0.01m 2m)" savecurrent=false
}
