...
T {CLOCK GENERATION} 370 -600 0 0 1 1 {}
T {Artificially generate a clock signal and ensure it 
turns off after around .425ms, which is when the 
scan in signal has fully propogated through the scan chain} 350 -530 0 0 0.4 0.4 {}
...
N 240 -230 240 -180 {lab=#net3}
N 240 -120 240 -80 {lab=GND}
N 240 -240 340 -240 {lab=#net3}
N 240 -240 240 -230 {lab=#net3}
N 510 -240 590 -240 {lab=CLK}
N 430 -370 430 -290 {lab=!CLK_ENA}
N 430 -390 530 -390 {lab=!CLK_ENA}
N 530 -390 530 -370 {lab=!CLK_ENA}
N 530 -310 530 -290 {lab=GND}
N 430 -390 430 -370 {lab=!CLK_ENA}
N 430 -220 430 -180 {lab=CLK_ENA}
N 430 -180 480 -180 {lab=CLK_ENA}
N 480 -180 480 -150 {lab=CLK_ENA}
N 480 -90 480 -70 {lab=GND}
N 390 -190 390 -170 {lab=GND}
N 380 -320 380 -290 {lab=VDD}
N 740 -240 740 -190 {lab=GND}
N 740 -190 740 -150 {lab=GND}
N 740 -250 840 -250 {lab=GND}
N 740 -250 740 -240 {lab=GND}
N 1010 -250 1090 -250 {lab=CLK}
N 930 -230 930 -190 {lab=!CLK_ENA}
N 890 -200 890 -180 {lab=GND}
N 880 -330 880 -300 {lab=VDD}
N 930 -340 930 -300 {lab=CLK_ENA}
N 480 -180 550 -180 {lab=CLK_ENA}
N 530 -390 600 -390 {lab=!CLK_ENA}
N -1080 50 -1080 100 {lab=#net4}
N -1080 50 -1040 50 {lab=#net4}
...
C {devices/code_shown.sym} 860 270 0 0 {name=MODELS only_toplevel=true
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice typical
"}
C {code_shown.sym} 860 370 0 0 {name=Simulation1 only_toplevel=false 
...
C {vsource.sym} 240 -150 0 0 {name=V9 value="PULSE(0 3.3 0 1n 1n 0.025m 0.05m)" savecurrent=false}
C {gnd.sym} 240 -80 0 0 {name=l12 lab=GND}
C {lab_pin.sym} 590 -240 0 1 {name=p7 sig_type=std_logic lab=CLK}
C {libs/core_digital/schem/transmission_gate.sym} 430 -240 0 0 {name=x3}
C {vsource.sym} 530 -340 0 0 {name=V10 value="PWL(0 0 0.42501m 0 0.42502m 3.3)" savecurrent=false}
C {gnd.sym} 530 -290 0 0 {name=l13 lab=GND}
C {vsource.sym} 480 -120 0 0 {name=V11 value="PWL(0 3.3 0.42501m 3.3 0.42502m 0)" savecurrent=false}
C {gnd.sym} 480 -70 0 0 {name=l14 lab=GND}
C {gnd.sym} 390 -170 0 0 {name=l15 lab=GND}
C {lab_pin.sym} 380 -320 0 0 {name=p10 sig_type=std_logic lab=VDD}
C {gnd.sym} 740 -150 0 0 {name=l16 lab=GND}
C {lab_pin.sym} 1090 -250 0 1 {name=p14 sig_type=std_logic lab=CLK}
C {libs/core_digital/schem/transmission_gate.sym} 930 -250 0 0 {name=x4}
C {gnd.sym} 890 -180 0 0 {name=l17 lab=GND}
C {lab_pin.sym} 880 -330 0 0 {name=p15 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 930 -340 0 1 {name=p16 sig_type=std_logic lab=CLK_ENA}
C {lab_pin.sym} 930 -190 0 1 {name=p17 sig_type=std_logic lab=!CLK_ENA}
C {lab_pin.sym} 550 -180 0 1 {name=p18 sig_type=std_logic lab=CLK_ENA}
C {lab_pin.sym} 600 -390 0 1 {name=p19 sig_type=std_logic lab=!CLK_ENA}
