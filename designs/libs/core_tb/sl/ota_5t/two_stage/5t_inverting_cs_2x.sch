...
5t 2x and common source 1x sizing} 260 160 0 0 0.4 0.4 {}
T {CL = 120p} -380 150 0 0 0.75 0.75 {}
T {IBIAS = 100u} -1380 160 0 0 0.4 0.4 {}
T {IMPLEMENTATION} -1350 -680 0 0 1 1 {}
T {Configure the 5t OTA in 2× mode and the common source stage 
in 2x mode as a two-stage inverting amplifier to amplify a sine wave 
...
C {vsource.sym} 360 370 0 0 {name=V3 value="PWL(0 0 0.0499m 0 0.05m 3.3 0.0999m 3.3 0.1m 0 0.1499m 0 0.15m 3.3 0.1999m 3.3 0.2m 0)" savecurrent=false}
