...
N 240 -240 240 -190 {lab=#net3}
N 240 -130 240 -90 {lab=GND}
N 240 -250 340 -250 {lab=#net3}
N 240 -250 240 -240 {lab=#net3}
...
C {devices/code_shown.sym} 860 250 0 0 {name=MODELS only_toplevel=true
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice typical
"}
C {code_shown.sym} 860 360 0 0 {name=Simulation1 only_toplevel=false 
...
C {vsource.sym} 240 -160 0 0 {name=V8 value="PULSE(0 3.3 0 1n 1n 0.025m 0.05m)" savecurrent=false}
C {gnd.sym} 240 -90 0 0 {name=l11 lab=GND}
...
C {vsource.sym} 530 -350 0 0 {name=V9 value="PWL(0 0 0.42501m 0 0.42502m 3.3)" savecurrent=false}
C {gnd.sym} 530 -300 0 0 {name=l12 lab=GND}
C {vsource.sym} 480 -130 0 0 {name=V10 value="PWL(0 3.3 0.42501m 3.3 0.42502m 0)" savecurrent=false}
C {gnd.sym} 480 -80 0 0 {name=l13 lab=GND}
C {gnd.sym} 390 -180 0 0 {name=l14 lab=GND}
C {lab_pin.sym} 380 -330 0 0 {name=p10 sig_type=std_logic lab=VDD}
C {gnd.sym} 740 -160 0 0 {name=l15 lab=GND}
...
C {gnd.sym} 890 -190 0 0 {name=l16 lab=GND}
...
C {vsource.sym} -1080 130 0 0 {name=V2 value=3.3 savecurrent=false}
C {gnd.sym} -1080 180 0 0 {name=l4 lab=GND}
