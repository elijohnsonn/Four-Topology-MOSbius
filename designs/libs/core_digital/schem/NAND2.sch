...
N -20 -120 40 -120 {lab=Y}
N 40 -120 40 -110 {lab=Y}
N 40 -120 40 -110 {lab=Y}
N 40 -120 110 -120 {lab=Y}
N 110 -150 110 -120 {lab=Y}
...
N -40 10 -0 10 {lab=B}
N 110 -120 140 -120 {lab=Y}
N 40 -170 70 -170 {lab=B}
...
C {lab_wire.sym} -20 10 0 0 {name=p6 sig_type=std_logic lab=B}
C {lab_wire.sym} 50 -170 0 0 {name=p7 sig_type=std_logic lab=B}
