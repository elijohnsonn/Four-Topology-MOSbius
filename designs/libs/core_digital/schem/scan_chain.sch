...
N 1390 -80 1440 -80 {lab=EN_0_CS}
N 1440 -80 1440 -70 {lab=EN_0_CS}
N 1180 -80 1220 -80 {lab=EN_1_5T}
N 1220 -80 1220 -70 {lab=EN_1_5T}
N 960 -80 1010 -80 {lab=EN_0_5T}
N 1010 -80 1010 -70 {lab=EN_0_5T}
N 790 -80 790 -70 {lab=EN_1_TELESCOPIC}
N 740 -80 790 -80 {lab=EN_1_TELESCOPIC}
N 570 -80 570 -70 {lab=EN_0_TELESCOPIC}
N 530 -80 570 -80 {lab=EN_0_TELESCOPIC}
N 360 -80 360 -70 {lab=EN_1_FOLDED}
N 310 -80 360 -80 {lab=EN_1_FOLDED}
N 90 -80 140 -80 {lab=EN_0_FOLDED}
N 140 -80 140 -70 {lab=EN_0_FOLDED}
...
N 1610 -80 1660 -80 {lab=EN_1_CS}
N 1660 -80 1660 -70 {lab=EN_1_CS}
...
C {opin.sym} 90 0 1 0 {name=p5 lab=!EN_0_FOLDED}
C {opin.sym} 530 0 1 0 {name=p6 lab=!EN_0_TELESCOPIC}
C {opin.sym} 310 0 1 0 {name=p7 lab=!EN_1_FOLDED}
C {opin.sym} 740 0 1 0 {name=p8 lab=!EN_1_TELESCOPIC}
C {opin.sym} 960 0 1 0 {name=p9 lab=!EN_0_5T}
C {opin.sym} 1180 0 1 0 {name=p10 lab=!EN_1_5T}
C {opin.sym} 1390 0 1 0 {name=p11 lab=!EN_0_CS}
C {opin.sym} 1610 0 1 0 {name=p12 lab=!EN_1_CS}
C {opin.sym} 1900 -80 0 0 {name=p13 lab=scan_out}
C {opin.sym} 1640 -80 3 0 {name=p14 lab=EN_1_CS}
C {opin.sym} 1410 -80 3 0 {name=p15 lab=EN_0_CS}
C {opin.sym} 1200 -80 3 0 {name=p16 lab=EN_1_5T}
C {opin.sym} 990 -80 3 0 {name=p17 lab=EN_0_5T}
C {opin.sym} 760 -80 3 0 {name=p18 lab=EN_1_TELESCOPIC}
C {opin.sym} 550 -80 3 0 {name=p19 lab=EN_0_TELESCOPIC}
C {opin.sym} 340 -80 3 0 {name=p20 lab=EN_1_FOLDED}
C {opin.sym} 120 -80 3 0 {name=p21 lab=EN_0_FOLDED}
