...
N 420 -190 530 -190 {lab=vcur}
N 570 -160 570 -130 {lab=GND}
N 680 -450 760 -450 {lab=vout}
N 570 -700 570 -660 {lab=vdd}
N 390 -350 420 -350 {lab=vin+}
N 720 -350 750 -350 {lab=#net3}
...
C {lab_pin.sym} 390 -350 0 0 {name=p6 sig_type=std_logic lab=vin+}
C {lab_pin.sym} 750 -350 2 0 {name=p3 sig_type=std_logic lab=vin-}
